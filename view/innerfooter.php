...
<footer class="bg-dark text-center text-white  ">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post">
          ...
          <div class="row d-flex justify-content-center">
            ...
            <div class="col-md-5 col-12">
              ...
              <input type="text" name="reg_email" id="reg_email" placeholder="reg_email Address" value="<?php echo $inputs['reg_email'] ?? '' ?>" class="<?php echo isset($errors['reg_email']) ? 'error' : '' ?> form-control ">
  ...
  <div class="nav justify-content-center">
    <li class="nav-item">
      <a class="nav-link text-light small" href="../view/refound_policy.php">Refound Policy</a>
    </li>
    <li class="nav-item">
      <a class="nav-link text-light small" href="../view/privacy_policy.php">Privacy Policy</a>
    </li>
    <li class="nav-item">
      <a class="nav-link text-light small" href="../view/terms_and_condition.php">Terms and Conditions</a>
    </li>
  </div>
